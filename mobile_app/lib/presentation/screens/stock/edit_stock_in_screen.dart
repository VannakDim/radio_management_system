...
class EditStockInScreen extends StatefulWidget {
  ...
  const EditStockInScreen({super.key, required this.item});

  @override
  State<EditStockInScreen> createState() => _EditStockInScreenState();
}
...
class _EditStockInScreenState extends State<EditStockInScreen> {
  ...
  void initState() {
    super.initState();
    _invoiceController = TextEditingController(text: widget.item['invoice_no'] ?? '');
    ...
    try {
      ...
      if (response.data['success'] == true) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('Stock In updated successfully ✓'), backgroundColor: Colors.green),
        );
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('កែប្រែ Stock In / Edit Stock In'),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      TextFormField(
                        ...
                        decoration: const InputDecoration(
                          labelText: 'Supplier / ក្រុមហ៊ុនផ្គត់ផ្គង់',
                          border: OutlineInputBorder(),
                      ...
                      : existingImageUrl != null
                          ? Stack(
                              children: [
                                ClipRRect(
                                  borderRadius: BorderRadius.circular(10),
                                  child: Image.network(existingImageUrl, width: double.infinity, height: 180, fit: BoxFit.cover,
