<!-- filepath: /Users/t2/Desktop/Radio TEAM/radio_management_system/resources/views/admin/product/stockin/edit.blade.php -->
                    ...
                    <div class="col-md-12">
                        <div class="card card-default">
                            <div class="card-header card-header-border-bottom">
                                <h2 class="badge badge-primary text-white">EDIT STOCK IN</h2>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                @endif
                                <form id="uploadForm" method="POST" action="{{ route('stockin.update', $stock_in->id) }}"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="invoice_no" class="form-control"
                                                    id="exampleInputEmail1" placeholder="invoice_no" value="{{ $stock_in->invoice_no }}">
                                            </div>

                                            <div class="form-group">
                                                <label for="exampleInputEmail1">Supplier:</label>
                                                <input type="text" name="supplier" class="form-control"
                                                    id="exampleInputEmail1" placeholder="supplier" value="{{ $stock_in->supplier }}">
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="post-img" id="img-preview"
                                                style="display: flex; justify-content: center; align-items: center; background-image: url({{ $stock_in->image ? asset( $stock_in->image) : asset('backend/assets/img/default-image.avif') }}); background-size: contain; background-repeat:no-repeat; background-position: center; width: 100%; height: 100%;">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
...
@section('script')
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    window.location.href =
                        '{{ route('stockin.index') }}'; // Redirect to the "index" route
                },
                error: function(xhr) {
                    // Hide loading indicator
                    $('#loading').hide();
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            @foreach ($stock_in->detail as $detail)
                items.push({
